...
describe('bannerMapper()', () => {
  it('should return the right format when mapped', () => {
    ...
    expect(bannerMapper([banner])).toStrictEqual([
      {
        img: `${process.env.NEXT_PUBLIC_IMAGE_HOST}/image.jpg`,
        title: 'Banner title',
        subtitle: 'Banner subtitle',
...
describe('gamesMapper()', () => {
  it('should return an empty array if there are no games', () => {
    expect(gameSliderMapper(null)).toStrictEqual([])
  })
  ...
  it('should return the correct format when mapped', () => {
    ...
    expect(gameSliderMapper([game])).toStrictEqual([
      {
        id: '1',
        title: 'game',
        slug: 'game',
...
describe('highlightMapper()', () => {
  ...
  it('should return mapped highlight', () => {
    ...
    expect(highlightMapper(highlight)).toStrictEqual({
      title: 'title',
      subtitle: 'subtitle',
      backgroundImage: `${process.env.NEXT_PUBLIC_IMAGE_HOST}/image.jpg`,
      buttonLabel: 'button label',
      buttonLink: 'button link',
      alignment: 'right',
      floatImage: `${process.env.NEXT_PUBLIC_IMAGE_HOST}/image.jpg`
    })
  })
})
